                ...
                switch (key) {
                    ...
                    case BYTE:
                        if (val instanceof Map) {
                            ...
                            urls.forEach((k, v) -> save(k, v));
                        } else if (val instanceof PipelineExt) {
                            if (Objects.isNull(service)) {
                                service = GuavaThreadPoolUtils.getDefualtGuavaExecutor();
                            }
                            PipelineExt pipelineExt = (PipelineExt) val;
                            pipelineExt.getByteBeans().forEach((result -> save(result.getName(), result.getUrl())));
                        }
                        break;
                    case BYTES:
